...
export class AuthService {
  ...
  guardarUsuario(access_token: string): void {
    let payload = this.parseToken(access_token);
  ...
  parseToken(access_token: string): any {
  ...
  isAuthenticated(): boolean {
    let payload = this.parseToken(this.token);  //  Obtener datos desde el metodo get
  ...
  tienePermiso(role: string): boolean{
